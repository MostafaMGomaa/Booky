        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              body.insertAdjacentHTML('beforeend', (0, _alert.showAlert)('success', 'fa-solid fa-universal-access', 'Login successfully'));
          ...
          case 7:
            ...
            body.insertAdjacentHTML('beforeend', (0, _alert.showAlert)('err', 'fa-solid fa-universal-access', 'Login Incomeplete'));
            btnClose = document.querySelectorAll('.btn-close');
            alerts = document.querySelectorAll('.alert');
            if (btnClose) btnClose.forEach(function (btn) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            body.insertAdjacentHTML('beforeend', (0, _alert.showAlert)('err', 'fa-solid fa-universal-access', 'Logout Incomeplete'));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              body.insertAdjacentHTML('beforeend', (0, _alert.showAlert)('success', 'fa-solid fa-check-double', 'Data update successfully'));
            }
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            body.insertAdjacentHTML('beforeend', (0, _alert.showAlert)('err', 'fa-solid fa-triangle-exclamation', _context.t0.response.data.message));
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee2(currentPassword, newPassword, newPasswordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            body.insertAdjacentHTML('beforeend', (0, _alert.showAlert)('err', 'fa-solid fa-triangle-exclamation', _context2.t0.response.data.message));
...
// DOM ElEMENTS
var arrowRightBtn = document.querySelectorAll('.books-holder-right-arrow-btn');
var arrowLeftBtn = document.querySelectorAll('.books-holder-left-arrow-btn');
var loginForm = document.querySelector('.login-form');
var logoutBtn = document.querySelector('.logout-btn');
var userInfoForm = document.querySelector('#account-setting__form');
var userPasswordForm = document.querySelector('#account-password__form'); // EVENTS LISTNERS
// Scrol bookConatiners left and right.

arrowRightBtn.forEach(function (btn) {
  btn.addEventListener('click', function () {
    btn.parentElement.scrollBy(200, 0);
  });
});
arrowLeftBtn.forEach(function (btn) {
  btn.addEventListener('click', function () {
    btn.parentElement.scrollBy(-200, 0);
  });
}); // Login.
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', function (e) {
  ...
  var newPasswordConfirm = document.querySelector('#confirm-newpassword').value;
  (0, _updateSettings.updateUserPassword)(currentPassword, newPassword, newPasswordConfirm); // console.log(currentPassword, newPassword, confirmNewPassword);
});
